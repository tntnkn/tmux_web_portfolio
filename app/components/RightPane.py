...
contacts_page = html.Div(html.Pre(
    ...
    children=[
        ...
        html.Code([html.Span(className='th'),"    email: ", html.Span(children="Link", className="kw3"), " = ", '"',html.A(children=["anton@tonotonokon.com"], href="mailto:anton@tonotonokon.com"),'"',], className='tr'),
        html.Code([html.Span(className='th'),""], className='tr'),
...
projects_page = html.Pre(
    ...
    children=[
        ...
        html.Code(["       .link = Link(",html.Span(children=['"',html.A(['homepage of this project'], href=maxdmg_github),'"'], className="kw1"),"),",]),
        html.Code(["       .demo = Link(",html.Span(children=['"',html.A(['product powered by this project'], href=maxdmg_demo),'"'], className="kw1"),"),",]),
        html.Code(["       .tech = {",]),
